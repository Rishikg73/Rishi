            ...
            <?php if(isset($_SESSION['change'])) 
              ...
              <div class="home-tab">
                ...
                <a href="http://localhost/star-admin/template/employeeprofile.php" style="text-decoration:none">  <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">View profile</button>
                 ...
                 <li class="nav-item" role="presentation">
                 <a href="http://localhost/star-admin/template/editprofile.php" style="text-decoration:none"><button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Edit profile</button>
                 </a>
                </li>
                  <li class="nav-item" role="presentation">
                   <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">change profile</button>
                  </li>
                 ...
                 <div class="dropdown-menu">
                      ...
                      <!-- save pages -->
                       <!-- <a class="dropdown-item" href="" save>
                        ...
                        <!-- share email -->
                        <a class="dropdown-item" href="https://www.addtoany.com/add_to/email?linkurl=http%3A%2F%2Flocalhost%2Fstar-admin%2Ftemplate%2Fchangeprofile.php&amp;linkname="><i class="fa-solid fa-envelope"></i> Email</a>
                          <!-- share whatsapp -->
                         <a class="dropdown-item" href="https://www.addtoany.com/add_to/whatsapp?linkurl=http%3A%2F%2Flocalhost%2Fstar-admin%2Ftemplate%2Fchangeprofile.php&amp;linkname=" target="_blank" >
                            <i class="fa-brands fa-whatsapp green"></i> Whatsapp</a> 
                            <!-- share facebook -->
                            <a href="https://www.addtoany.com/add_to/facebook?linkurl=http%3A%2F%2Flocalhost%2Fstar-admin%2Ftemplate%2Fchangeprofile.php&amp;linkname=" target="_blank" style="text-decoration:none; margin-left:15px;" > 
...
<div class="content-wrapper container-fluid" >
              <div class="card w-100 h-100" style="border-radius:25px; width: 80rem; " >
                <div class="card-body "> 
                  <h4 class="card-header bg-white fs-5 p-2">Chage profile</h4> 
                  
                    <form action="upload.php" method="post" id="upload_image">
                    ...
                    <h4 class="mt-2" style="margin-left:570px;"><?php echo $result['fname'];?><?php echo $result['lname'];?></h4>
                     ...
                     <input type="file" name="image" class="form-control w-50 mt-3" style="margin-left:500px;" accept="image/png" required><br><br>
                    <!-- <input type="file" name="profile" class="form-control"> <br><br> -->
                    <input type="submit" name="save" value="Update" style="margin-left:550px;" class="btn btn-primary btn-lg text-white">
 
                    <!-- <button type="submit" name="send" value="login" class="button btn btn-primary text-white">
