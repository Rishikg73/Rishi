          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <p class="mb-1 mt-3 font-weight-semibold"> <?php echo $result['fname']; ?><?php echo  $result['lname']; ?> </p>
             <p class="fw-light text-muted mb-0"><?php echo $email;?></p>
              ...
              <button type="submit" name="logout_btn" onclick="return confirm('Are you sure logout?');" class="dropdown-item">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
             ...
             <?php if(isset($_SESSION['success'])) 
          {
            ?>
            <div class="alert alert-success alert-dismissible fade show fs-5">
                  <?php echo $result['fname']; ?><?php echo $result['lname']; ?> <?php  echo $_SESSION['success']; ?>
                  <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
             </div>
            <?
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="delemp" class="btn btn-danger text-white">Yes</button>
          ...
          ?>
                  ...
                  <!-- <a href="http://localhost/star-admin/template/pages/samples/employeeadd.php" target="_blank">
                       ...
                       <!-- change status -->             
                       <!-- <button type="submit" onclick="return changestatus()" name="statusbtn" id="text" class="btn btn-primary me-3 text-white ">Change Status</button> -->
                  <!-- <button type="submit"  class="btn btn-primary me-3 text text-white mulbtn" id="mulchange" name="mulchange" onclick="return changestatus()"> 
                  changestatus</button> -->
                  <!-- <button type="submit"  style="margin-left:1100px;"  class="btn btn-success  text-white mulsbtn" id="mulschange" name="mulschange" onclick="return changests()"> 
                  Active</button>

                  <button type="submit"   class="btn btn-danger me-3 text text-white mulbtn" id="mulchange" name="mulchange" onclick="return changestatus()"> 
                  Inactive</button>
                -->
                       <!-- delete status -->
                       ...
                       <!-- <button type="submit"  class="btn btn-danger me-2 txt1 text-white muldeltbtn" id="muldelete" name="muldelete" onclick="return multipledelete()"> 
                        Delete</button>
                    -->
           ...
           <div class="col-lg grid-margin stretch-card">
              ...
              <!-- add employee -->
                <a href="http://localhost/star-admin/template/pages/samples/employeeadd.php" target="_blank">
                        <button type="submit" name="adduser" id="adduser" class="btn btn-primary text-white mdi mdi-account-plus"> Addemployee</button></a> 
                <!-- change status -->
                        <button type="submit"  style="margin-left:1060px;"  class="btn btn-success  text-white mulsbtn" id="mulschange" name="mulschange" onclick="return changests()"> 
                  Active</button>

                  <button type="submit"   class="btn btn-danger  text text-white mulbtn" id="mulchange" name="mulchange" onclick="return changestatus()"> 
                  Inactive</button>
               
                       <!-- delete status -->
                       <!-- <button type="submit" onclick="return multipledelete()" name="statusbtn1" id="txt1" class="btn btn-danger me-3 text-white">Delete</button> -->
                       <button type="submit"  class="btn btn-danger  text-white muldeltbtn" id="muldelete" name="muldelete" onclick="return multipledelete()"> 
                        Delete</button>
        ...
        <thead>        
         <tr>
           <!-- <th><input type="button" class="btn btn-primary" value="selectall" onclick="selects()"></th> -->
           <th></th>
           <th>First Name</th>
           <th>Last Name</th>
           <th>Age</th>
           ...
           function activestatus(id,status)
           {
             ...
             var formData = new FormData();
              ...
              // if (confirm('Are you sure you want active status')) {
                ...
                // bootbox.confirm('Are you sure you want active status'){ 
            ...
            function singledelete(id,status)
           {
            var delt = document.getElementById("delete").value;
             ...
             if (confirm('Are you sure you want to delete status?')) {
                     ...
                     var request = new XMLHttpRequest();
                     request.open("POST", "singledelete.php");
                     request.send(formData);
...
<!--multiple users chnge status  -->
             <script>
                function changestatus() {  

               $(document).ready(function(){

                 $('.mulbtn').click(function (e){
                  e.preventDefault();
                 ...
                 id = checkbox.getAttribute('data-id');
                  ...
                  //  var status = $(this).val();
                   ...
                   swal({
                       title: "Are you sure you want changestatus?",
                       icon: "warning",
                       buttons: true,
                       dangerMode: true,
                     })
                   .then((willDelete) => {
                     if (willDelete) {
                          $.ajax({
                              ...
                              data: {
                              // mulchange:'mulchange',
                              'mulchange': JSON.stringify(arr),
                              id:id,
                              status:status,
                           },
                    success: function (response) {
                      if(response){
                           swal("success!", "succesfully change status!", "success");
                          //  $('#etable').load(location.href + "#etable");
                          location.reload();
                        }
                        else{
               ...
               $(document).ready(function(){
                 ...
                 id = checkbox.getAttribute('data-id');
                  ...
                  //  var status = $(this).val();
                   ...
                   swal({
                       title: "Are you sure you want deletestatus?",
                       icon: "warning",
                       buttons: true,
                       dangerMode: true,
                     })
                   .then((willDelete) => {
                     if (willDelete) {
                          $.ajax({
                              ...
                              data: {
                              // mulchange:'mulchange',
                              'muldlete': JSON.stringify(arr),
                              id:id,
                              status:status,
                           },
                    success: function (response) {
                      if(response){
                           swal("success!", "succesfully status deleted!", "success");
                          //  $('#etable').load(location.href + "#etable");
                          location.reload();
                        }
                        else{
