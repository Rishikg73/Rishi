            ...
            <?php if(isset($_SESSION['change'])) 
              ...
              <div class="home-tab">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                 ...
                 <li class="nav-item" role="presentation">
                  <button class="nav-link" id="pswd-tab" data-bs-toggle="tab" data-bs-target="#pswd" type="button" role="tab" aria-controls="pswd" aria-selected="false">Change profile</button>
                 </li>
                 <!-- <li class="nav-item" role="presentation">
...
<div class="col-12">
          ...
          <!-- <div class="row"> -->
            <div class="col-lg " >
              <div class="card col-lg" style="border-radius:25px;" >
                <div class="card-body"> 
                  <h4 class="card-title bg-primary p-3 text-white">Edit employee</h4> 
                            ...
                            <form action="updatecode.php" method="POST" id="edit_form"> 
                                ...
                                <div class="center">
                                    ...
                                    <div class="col-5 mb-3">
                                        ...
                                        <button type="submit" name="update_user" class="btn btn-primary text-white">update</button>
                                </div>
                            </form>
 ...
 <!-- change password  -->
<div class="tab-pane fade" id="pswd" role="tabpanel" aria-labelledby="pswd-tab">
<style>
  .abc{
    margin-left:500px;
                ...
                <div class="card-body "> 
                  <h5 class="card-title bg-primary fs-4 p-3 text-white">Change profile</h5> 
                    ...
                    <h4 class="mt-2" style="margin-left:570px;"><?php echo $result['fname'];?><?php echo $result['lname'];?></h4>
                     ...
                     <!-- <img src="http://localhost/star-admin/template/img/<?php echo $result['image']; ?>" style="width:5%; margin-bottom:50px; margin-left:500px;"><br> -->
