      ...
      <div class="card col-lg" style="border-radius:25px;" >
        <div class="card-body" > 
            <h4 class="card-title bg-primary p-4 text-white fs-2">Change password</h4> 
                ...
                <form class="" name="validate" id="validateForm" action="" method="post" >
                   ...
                   <div class="col-5 mb-5 fs-3">
                      <label for="" class="mt-4 ">Old password</label>
                        ...
                        <div class="col-5 fs-3 mb-4">
                            <label class="col-12 control-label " for="passwordinput">Password <span id="popover-password-top" class="hide pull-right block-help"><i class="fa fa-info-circle text-danger" aria-hidden="true"></i> Enter a strong password</span></label>
                            <div class="col-12 ">
                                <input id="password" name="password" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" 
                                title="Must contain at least one uppercase and one lowercase letter and number, and at least 5 or more characters" 
                        ...
                        <div class="col-5 fs-3">
                            <label class="col-12 control-label" for="passwordinput">Password Confirmation <span id="popover-cpassword" class="hide pull-right block-help"><i class="fa fa-info-circle text-danger" aria-hidden="true"></i> Password don't match</span></label>
                            <div class="col-12">
                                <input id="cpassword" name="cpassword" 
                                pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{5,}" 
                                title="Must contain at least one uppercase and one lowercase letter and number, and at least 5 or more characters"  
                                type="password" placeholder="Re enter password" class="form-control input-md fs-3 p-4" required  onkeyup="validate_password()">
                            </div>
                        </div>
                        <span id="wrong_pass_alert"></span>
                        <div class="mt-4">
                           <button type="submit" class="btn btn-primary text-white " id="submit" onclick="wrong_pass_alert()">Change password</button>
                        </div>
                </form>
            </div>
        </div>
