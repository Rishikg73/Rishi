            ...
            <div class="col-lg ">
              ...
              <div class="row">
                ...
                <label class="form-label fs-5">Confirm Password <i class="text-danger">*</i></label>
                  <div class="form-outline">
                  <input type="password" class="form-control" id="cpassword" name="cpassword" placeholder="enter your confirm password"><br>
             ...
             <a href="http://localhost/star-admin/template/emptables.php"  type="button" class="btn ml-4 mt-3 bg-secondary btn-light text-white"  id="" style ="width:40%; margin-left:50px;">Cancel</a>
